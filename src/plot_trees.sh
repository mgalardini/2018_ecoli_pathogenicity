...
src/plot_virulence out/gubbins/tree.nwk data/phenotypes/phenotypes.tsv data/phylogroups.tsv out/roary/gene_presence_absence.Rtab out/virulence_genes.tsv data/hpi.tsv out/plots/ --width 5 --dpi 300 --extension pdf --prefix 7_
